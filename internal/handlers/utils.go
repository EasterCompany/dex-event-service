...
func HandleFabricatorIntent(ctx context.Context, content string, userID string, channelID string, serverID string, deps *Dependencies) (bool, error) {
	// 1. Check Intent
